<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tool3.aspx.cs" Inherits="WebApp.yx.tool3" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function getPrice(txtid, txtval) {
            ...
            document.getElementById("litzjs").innerHTML = parseFloat(document.getElementById("litzsq").innerHTML) * parseFloat(2.2) * parseFloat(document.getElementById("litgm").value);
        }
        function initjisuan() {
            document.getElementById("txtrznfcb").value = document.getElementById("txtrznfbs").value * document.getElementById("txtrznfbj").value;
            document.getElementById("txtrznfcb0").value = document.getElementById("txtrznfbs0").value * document.getElementById("txtrznfbj0").value;
    ...
    <form id="form1" runat="server">
        <table width="98%" align="center" style="text-align: center; font-size: 12px;" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td colspan="3" bgcolor="#CCFF99"><strong><font size="5">正大“36950+55”模式</font></strong><br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input id="txtzhongzcb" value="7250" type="text" runat="server" style="border: 0" readonly="readonly" /></td>
                <td class="auto-style2">
                    <strong>中猪料</strong></td>
                <td class="auto-style2">
            ...
            <tr>
                <td colspan="8" style="text-align: center;" class="auto-style1"><strong><font size="5"><span style="color: red">猪三乐</span>比<span style="color: red"><asp:Label ID="lbdfsl" runat="server" Text="正大"></asp:Label></span>饲料每窝节省<span style="color: red; font-size: 35px"><asp:Label ID="litzsq" runat="server" Text="1140"></asp:Label></span>元  
                    <br />
                    ...
                    元
                    <span style="font-size:15px">（按1头母猪1年<strong><font size="5"><input id="TxtTaiShu" value="2.2" type="text" runat="server" style="border: 0px; width: 25px; font-size: 15px; text-decoration: underline;" onblur="getPrice('TxtTaiShu',2.2)" onfocus="javascript:document.getElementById('TxtTaiShu').value = ''" /></font></strong>胎计算）</span><br />
                    <span style="color: red;  font-size: 25px; font-family: 微软雅黑;">您选对了吗？<br />
                        不算不知道，一算吓一跳!猪三乐饲料是您最好的选择！</span></font></strong></td>
            </tr>
            <%--<tr>
                <td colspan="8" style="text-align: center;" class="auto-style1"><strong><font size="5"><span style="color: red">双胞胎集团猪三乐饲料</span>一窝节省<span style="color: red; font-size: 35px"><asp:Label ID="litzsq" runat="server" Text="966"></asp:Label></span>
                    元  
                    <br />
                    如您的母猪（按1头母猪1年2.2胎计算）为<input id="litgm" value="100" type="text" runat="server" style="border: 0px; width: 100px; font-size: 25px; text-decoration: underline;" onkeyup="value=this.value.replace(/\D+/g,'')" onblur="getPrice('litgm',100)" onfocus="javascript:document.getElementById('litgm').value = ''" />头，则<span style="color: red">双胞胎猪三乐</span>为您节省<span style="color: red; font-size: 25px"><asp:Label ID="litzjs" runat="server" Text="9660"></asp:Label></span>
                    元<br />
                    <span style="color: red;font-size: 25px; font-family: 微软雅黑;">您选对了吗？<br />
                        不算不知道，一算吓一跳!猪三乐饲料是您最好的选择！</span></font></strong></td>
            </tr>--%>
