...
strFrame+='<table border=0 cellspacing=1 cellpadding=0 width=142 height=160 bordercolor=#63A3E9 bgcolor=#63A3E9 >';
...
strFrame+='           <table border=0 cellspacing=0 cellpadding=0 bgcolor=#63A3E9 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
