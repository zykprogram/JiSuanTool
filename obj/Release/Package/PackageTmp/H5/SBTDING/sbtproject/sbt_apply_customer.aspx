<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sbt_apply_customer.aspx.cs" Inherits="WebApp.H5.SBTDING.sbtproject.sbt_apply_customer" %>
...
<body>
    ...
    <div class="mui-input-row" style="margin: 10px 5px;">
        <textarea id="textarea" rows="3" placeholder="请填写" runat="server"></textarea>
    </div>
    ...
    <script>
        ...
        //    alert(document.getElementById("InputID").style.display);
            ...
            if (document.getElementById("textarea").value == "") {
                ...
                mui.ajax('sbt_yx_custdetail.aspx/insertvalue', {
                    data: {
                        ...
                        othercs: document.getElementById("otherCS").innerText,
