...
{
    public partial class sbt_apply_customer : System.Web.UI.Page
    {
        ...
        protected void getCustname(string id)
        {
            ...
            connstring.Open();
            //表头PK
            string strpk = "select * from sbt_customerlose a where id  ='" + id + "' ";
        ...
        public static string insertvalue(string reason, string reason2, string reason3, string competitor, string countermeasures, string id, string othercs,string issave)
        {
            ...
            //表头PK
            string str = "update sbt_customerlose set  issave='" + issave + "',othercompetitor='" + othercs + "',ts=to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'),reason2='" + reason2 + "',reason3='" + reason3 + "',reason='" + reason + "',competitor='" + competitor + "',countermeasures='" + countermeasures + "' where id='" + id + "'";
