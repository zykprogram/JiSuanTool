<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sbt_yx_custreport.aspx.cs" Inherits="WebApp.H5.SBTDING.sbtproject.sbt_yx_custreport" %>
<!DOCTYPE html>
<html style="height: 100%">
   ...
   <body style="height: 100%; margin: 0">
       ...
       <script type="text/javascript">
           ...
           var series = [];
           [['南昌', BJData], ['上海', SHData], ['广州', GZData]].forEach(function (item, i) {
               series.push({
                   name: item[0] + ' Top10',
                   type: 'lines',
                   zlevel: 1,
           ...
           option = {
               ...
               legend: {
                   ...
                   top: 'bottom',
                   left: 'right',
                   data: ['南昌 Top10', '上海 Top10', '广州 Top10'],
                   textStyle: {
                       color: '#fff'
                   },
                   selectedMode: 'single'
