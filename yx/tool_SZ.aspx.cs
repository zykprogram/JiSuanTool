...
namespace WebApp.yx
{
    public partial class tool_SZ : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                // GetURLText("http://59.55.142.211:8088/API/GetUserInfo.aspx");

                string mobile =Request.QueryString["username"];
                ...
                //{
                //    Common.MessageBox.Show(this, "手机号码未获取成功，请注销APP，重新登录。");
                //}
                //else
                //{
                //    DBCommon.DbHelperOra.LoginLog(TxtMobile.Text, Request.ServerVariables.Get("REMOTE_ADDR"), "称猪算账小工具");
                //}
            }
        ...
        protected void InsertValue()
        {
            ...
            " values ('" + str_pk_sz_JBXX + "','','" + StrSub + "', '" + StrDept + "', '', '" + TxtName.Value + "', '" + TxtAdd.Value + "', '" + TxtMobile.Text + "', '" + StrTBR + "',  to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'),'" + TxtKSRQ.Text + "','" + TxtPhone.Value + "','" + TxtZJ.Value + "','" + TxtImageID.Text + "','" + StrWrokcode + "','" + StrScur + "')";

            //表体SBT  PK
            //  string strpkY = "select pk_t_sz.nextval from dual ";
            ...
            string strSQLSBT = "insert into T_SZ_SZSJ (PK_SZ_JBXX,PK_T_SZ_DIC ,TOUS, CJZ, MJZ, ZYL, YLTS, TJYL, SLJG, RCSL, RZZ, LRB, JRB, BZZ, ZZ,type, TS)" +
        " values ( '" + str_pk_sz_JBXX + "','" + TxtSBTID.Text + "','" + TxtTS1.Text + "', '" + TxtCJZ1.Text + "', '" + TxtMJZ1.Text + "', '" + TxtZYL1.Text + "', '" + TxtYLTS1.Text + "', '" + TxtTJYL1.Text + "', '" + TxtCLJG1.Text + "', '" + TxtCSL1.Text + "', '" + TxtRZZ1.Text + "', '" + TxtLRB1.Text + "', '" + TxtJRB1.Text + "', '" + TxtBZZ1.Text + "', '" + LitBZZ.Text + "','Y', to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'))";
            ...
            //其他公司实证
            string strSQLQT = "insert into T_SZ_SZSJ ( PK_SZ_JBXX, PK_T_SZ_DIC,TOUS, CJZ, MJZ, ZYL, YLTS, TJYL, SLJG, RCSL, RZZ, LRB, JRB, BZZ, ZZ,type, TS)" +
        " values ('" + str_pk_sz_JBXX + "','" + TxtJXSID.Text + "', '" + TxtTS2.Text + "', '" + TxtCJZ2.Text + "', '" + TxtMJZ2.Text + "', '" + TxtZYL2.Text + "', '" + TxtYLTS2.Text + "', '" + TxtTJYL2.Text + "', '" + TxtCLJG2.Text + "', '" + TxtCSL2.Text + "', '" + TxtRZZ2.Text + "', '" + TxtLRB2.Text + "', '" + TxtJRB2.Text + "', '" + TxtBZZ2.Text + "', '" + LitBZZ.Text + "','N', to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'))";
        ...
        protected bool JiaoYan()
        {
            ...
            {
                Common.MessageBox.Show(this, "对比指标中双胞胎品牌未填写或不存在！");
            ...
            //{
            //    Common.MessageBox.Show(this, "双胞胎料肉比超出范围,请核对数据");
            //    return false;
            //}
        ...
        protected void BtnJS_Click(object sender, EventArgs e)
        {
            ...
            if (JiaoYan())
            {
                ...
                //string StrURL = "http://59.55.142.211:9527/RDP/ReportServer?reportlet=/SBT%2F%5B8425%5D%5B9500%5D%5B5206%5D%5B6790%5D%2F%5B79f0%5D%5B732a%5D%5B7b97%5D%5B8d26%5D.cpt&OP=view&xh=" + TextPK.Text;
